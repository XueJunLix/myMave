...
public class NumberUtils {
	...
	public static double add2(Object d1, Object d2) {
	 ...
	 * 提供精确的乘法运算.
	 */
	public static Double multiply2(Double v1, Double v2) {
		if(v1==null||v2==null){
			return 0d;
		}
		BigDecimal b1 = new BigDecimal(Double.toString(v1));
	...
	*/
	...
	public static String numToStringQfw(Double v) {
		if (v == 0) {
			return "0";
		}
		DecimalFormat df = new DecimalFormat("###,###,###,##0.00");
	...
	public static String numToStringQfw(Long v) {
		if (v == 0) {
			return "0";
		}
		DecimalFormat df = new DecimalFormat("###,###,###,##0.00");
	...
	public static String numToStringQfwNoXs(Double v) {
		if (v == 0) {
			return "0";
		}
	...
	public static String numToStringQfwNoXs(Long v) {
		if (v == 0) {
			return "0";
		}
		DecimalFormat df = new DecimalFormat("###,###,###,##0");
	...
	public static String numToStringQfw(Integer v) {
		if (v == 0) {
			return "0";
		}
		DecimalFormat df = new DecimalFormat("###,###,###,##0");
	...
	*/
	...
	public static void main(String[] args) {
		double divide = NumberUtils.divide(10, 2);
	}
}
