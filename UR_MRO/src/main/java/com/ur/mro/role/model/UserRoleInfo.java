...
/**
 * TableName MA_BASE_ACL_USER_ROLE
 * tableRemarks null
 */
//TODO add Serializable implements
@ApiModel(description = "MA_BASE_ACL_USER_ROLE null")
public class UserRoleInfo {
    ...
    @ApiModelProperty(value = "null")
    @Column(name = "USER_NAME", nullable = false, length = 50, precision = 0)
    private String userName;

    @ApiModelProperty(value = "null")
    @Column(name = "role_ID", nullable = false, length = 19, precision = 0)
    ...
    public void setUserName(String userName) {
        this.userName = StringUtils.isEmpty(userName) ? null : userName;
    }

    /**
     * columnName role_ID <br/>
