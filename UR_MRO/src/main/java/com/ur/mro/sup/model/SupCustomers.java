...
/**
 * TableName SRM_SUP_CUSTOMERS
 * tableRemarks null
 */
//TODO add Serializable implements
@ApiModel(description = "SRM_SUP_CUSTOMERS null")
public class SupCustomers {
    ...
    @ApiModelProperty(value = "null")
    @Column(name = "SALES_VOLUME", nullable = true, length = 10, precision = 0)
    private Integer salesVolume;

    @ApiModelProperty(value = "null")
    @Column(name = "SALES_RATIO", nullable = true, length = 6, precision = 2)
    ...
    //客户
    List<Attachment> kehuFiles = new ArrayList<Attachment>();

    public List<Attachment> getKehuFiles() {
        return this.kehuFiles;
    }

    public void setKehuFiles(List<Attachment> kehuFiles) {
        this.kehuFiles = kehuFiles;
    }
    ...
    /**
     * columnName SALES_RATIO <br/>
     * columnType decimal 6 2 <br/>
     * columnRemarks null <br/>
     * isPK false <br/>
     * nullAble true <br/>
     */
